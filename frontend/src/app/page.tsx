    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-all selection:bg-violet-100 selection:text-violet-900">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-b border-white/20 dark:border-slate-800/50">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login?mode=register" className="rounded-xl bg-slate-900 px-4 py-2.5 text-[11px] font-black uppercase tracking-widest text-white transition hover:scale-105 active:scale-95 dark:bg-white dark:text-slate-950 dark:shadow-none sm:px-6 sm:text-xs">
               GET STARTED
            </Link>
          </div>
        </div>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="relative z-10 space-y-8 animate-in fade-in slide-in-from-left duration-1000">
              ...
              <h1 className="text-4xl font-black leading-[0.95] tracking-tighter text-slate-900 dark:text-white sm:text-5xl md:text-7xl">
            ...
            <div className="relative grid h-[460px] grid-cols-12 grid-rows-12 gap-3 px-0 animate-in fade-in slide-in-from-right duration-1000 sm:h-[540px] sm:gap-4 lg:h-[600px]">
               {/* Main Visual */}
               <div className="group relative col-span-12 row-span-7 overflow-hidden rounded-[2rem] bg-slate-200 shadow-2xl sm:rounded-[2.5rem]">
                  ...
                  <div className="absolute bottom-5 left-5 right-5 sm:bottom-8 sm:left-8 sm:right-8">
                     <p className="text-lg font-black leading-tight tracking-tight text-white sm:text-2xl">Master Complex Systems through Inquiry.</p>
               ...
               {/* Stat Card */}
               <div className="group relative col-span-5 row-span-5 flex flex-col justify-between overflow-hidden rounded-[2rem] bg-violet-600 p-5 text-white shadow-2xl shadow-violet-200 dark:shadow-none sm:rounded-[2.5rem] sm:p-8">
               ...
               {/* Interaction Card */}
               <div className="col-span-7 row-span-5 flex flex-col gap-3 rounded-[2rem] border border-slate-100 bg-white p-5 shadow-xl dark:border-slate-800 dark:bg-slate-900 sm:rounded-[2.5rem] sm:gap-4 sm:p-8">
        ...
        <section id="features" className="px-4 py-24 sm:px-6 sm:py-32">
           <div className="max-w-7xl mx-auto space-y-16">
              ...
              {/* Wide Bento Feature */}
              <div className="group flex flex-col items-center gap-10 overflow-hidden rounded-[2.5rem] border border-slate-200 bg-slate-100 p-6 dark:border-slate-800 dark:bg-slate-900/50 sm:p-10 lg:flex-row lg:gap-16 lg:rounded-[3rem] lg:p-12">
        ...
        <section className="px-4 py-24 sm:px-6 sm:py-32">
           <div className="relative mx-auto max-w-5xl space-y-8 overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 text-center shadow-2xl sm:rounded-[3.5rem] sm:p-12 md:p-24">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-100 bg-white px-4 py-20 dark:border-slate-900 dark:bg-slate-950 sm:px-6">
         <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-6 lg:gap-12">
